...
from prediction.qgnn_final.relational import RelationCarryingQuantumCore as HypergraphQuantumCore
from prediction.qgnn_final.classical import AdaptiveClassicalCore
from prediction.qgnn_final.model import build_model

OUT=ROOT/'reports/qgnn/engineering_checks_final.json'
report={'architecture':'RC-HQGNN-v3','correction_cap_m':16.,'test_set_used':False,'checks':{},'profiling':{}}
def save():
