...
def main():
    ...
    p.add_argument('--kind',choices=['raj_quantum','raj_johnson','raj_multij_quantum','raj_multij_johnson','raj_paper_quantum','raj_paper_johnson','raj_paper_gin','raj_paper_ppgn','raj_weighted_multij_quantum','raj_paper_math_quantum','raj_paper_math_rowlocal_quantum','raj_paper_math_expadj_quantum','raj_subsetbuilder_weighted_johnson'],required=True)
