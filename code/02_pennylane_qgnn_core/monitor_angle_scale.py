"""Compact live status for the 0.5-pi angle-scale experiment."""
import json
import time
from pathlib import Path

base = Path(__file__).resolve().parent / "angle_scale_0p5_seed2026_v1"
while True:
    ...
    if progress.exists():
        ...
        if last:
            ...
            print(
                f"epoch {last['epoch']:02d}/{last['max_epochs']:02d} "
