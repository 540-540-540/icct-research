"""Select a classical/quantum prediction fusion on discovery blocks, then confirm once."""
import json
import platform
...
OUTPUT = BASE / "two_hop_quantum_fusion_seed2026_v1"
DATA = ROOT / "data/multitarget_lankershim_v1.npz"
SEED = 2026


def load_model(name):
    if name in ("classical", "quantum"):
...
def main():
    ...
    names = ("classical", "quantum", "quantum_score2", "quantum_rich")
