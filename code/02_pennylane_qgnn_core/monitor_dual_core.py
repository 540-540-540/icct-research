"""Compact live status for the dual-core experiment."""
import json
import time
from pathlib import Path

base = Path(__file__).resolve().parent / "dual_core_seed2026_v1"
while True:
    ...
    if progress.exists():
        ...
        if last:
            ...
            print(
                f"{last['arm']:16s} epoch {last['epoch']:02d}/{last['max_epochs']:02d} "
