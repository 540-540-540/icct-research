...
class FutureTokenCoreGraphLLM(CoreGraphLLM):
    ...
    def forward(self, history, target_mask):
        ...
        step_nodes = flat_nodes[:, None, :].expand(-1, self.config.prediction_length, -1)
