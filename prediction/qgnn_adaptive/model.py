...
def build_model(kind,seed=2026,depth=3,token_path=None,channels=4,enhanced=True,snr_db=0.,quantum_version=3,correction_cap_m=16.,adaptive_mode="phase_feedback",controller_init="neutral"):
